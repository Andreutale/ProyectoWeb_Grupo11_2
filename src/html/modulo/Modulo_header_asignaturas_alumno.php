...
<div class="header-container">
    ...
    <header>
        <!-- logo del módulo -->
        <a href="Modulo_Inicio_Sesion.php"><img class="logo" src="../../../images/logo_modulo.png" alt="Logo del apartado de modulo"></a>
        ...
        <nav class="menu-desplegable" id="menu">
            <ul>
                ...
                <li><a href="Modulo_recursos_alumno.php?asignatura_id=<?php echo $asignatura_id; ?>"><h3 class="recursos">Recursos</h3></a></li>
