...
<main>
    ...
    <div class="contenedor_pagina">
        <div class="contenedor_ruta">
            <h2>Ruta: <span id="cambio">Ejercicios-Ejemplos/JavaScript/</span></h2>
        ...
        <form action="../php/descarga.php" method="POST">
            <table id="tablaRecursos">
                ...
                <tr>
                    ...
                    <td><div class="nombreMasImagen"><img src="../../../images/iconos/icono_carpeta.png" alt="Icono de carpeta"><h3>Documentación_JS</h3></div></td>
                    <td><h3>Lucio</h3></td>
                    <td><h3 data-date="2022-08-21">21/08/22</h3></td>
                    <td><h3>Carpeta</h3></td>
                    ...
                    <td>
                        <div class="dropdown-container">
                            <button class="opciones"><h3>Opciones</h3><img class="flecha_desplegable" src="../../../images/iconos/icono_flecha_desplegable.png" alt="Icono de la flecha desplegable"></button>
                ...
                <tr>
                    ...
                    <td><div class="nombreMasImagen"><img src="../../../images/iconos/icono_fichero.png" alt="Icono de fichero"><h3>Ejemplo-Diseño</h3></div></td>
                    <td><h3>Lucio</h3></td>
                    <td><h3 data-date="2022-08-21">21/08/22</h3></td>
                    <td><h3>Imagen</h3></td>
                    <td class="responsive-actions">
                ...
                <tr>
                    ...
                    <td><div class="nombreMasImagen"><img src="../../../images/iconos/icono_fichero.png" alt="Icono de fichero"><h3>Prueba.txt</h3></div></td>
                    <td><h3>Lucio</h3></td>
                    <td><h3 data-date="2022-08-22">22/08/22</h3></td>
                    <td><h3>Documento <span class="datos_responsive"> de texto</span></h3></td>
                    <td class="responsive-actions">
                        <button class="btn-azul-claro btn-desplegable-responsive">
                            <img src="../../../images/iconos/icono_flecha_desplegable.png" alt="Mostrar más">
                        </button>
                    ...
                    <td>
                        <div class="dropdown-container">
                            <input type="hidden" name="id_fichero" value="5">
                            <button type="submit" class="btn-azul-claro">Descargar</button>
                        </div>
                    </td>
                </tr>
                </tbody>
...
<div id="modalAñadirRecurso" class="modal">
    <div class="modal-content">
        ...
        <form action="../php/Modulo_recursos_profesor.php" method="POST" enctype="multipart/form-data">
